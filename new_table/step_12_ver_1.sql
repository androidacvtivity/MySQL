...
`id_registru_05_14_24`.`GEN_ACT_NE_LIC` AS `depart`,
`id_registru_05_14_24`.`GEN_ACT_LIC` AS `phone`,
`id_registru_05_14_24`.`STATUTUL` AS `phoneinternal`
,date_format(`id_registru_05_14_24`.`DATA_REG`,'%Y-%m-%d') AS `email`,
NULL AS `personalinfo`, 
`id_registru_05_14_24`.`DATE_OF_LIQUID`  AS `DATE_OF_LIQUID`,
`id_registru_05_14_24`.`STATUTUL_DATE`  AS `STATUTUL_DATE`
